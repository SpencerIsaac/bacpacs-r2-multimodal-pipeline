...
- Added explicit CLI usage examples and full command syntax to help output.
...
- Updated the Streamlit control-panel drawer with a card header, R1/R2 segmented control, icon navigation, and tinted active states.
